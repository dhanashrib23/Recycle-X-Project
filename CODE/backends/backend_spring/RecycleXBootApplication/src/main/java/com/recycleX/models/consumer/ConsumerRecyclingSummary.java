...
public class ConsumerRecyclingSummary {
	private int categoryId;
	private String categoryName;
	private double totalQuantityKg;
	private String period;

	public ConsumerRecyclingSummary(int categoryId, String categoryName, double totalQuantityKg, String period) {
	...
	public String toString() {
		return "ConsumerRecyclingSummary [categoryId=" + categoryId + ", categoryName=" + categoryName
